...
try{
	...
	String SQL1 = "SELECT orderId, Customer.cid, cname, totalPrice FROM Orders JOIN Customer ON Orders.customerId = Customer.cid WHERE Customer.cid = ?";
	PreparedStatement pstmt1 = con.prepareStatement(SQL1);
	pstmt1.setInt(1, cid2);
