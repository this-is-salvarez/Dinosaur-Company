...
<body>
<h2>. </h2>
<h1>We are adding your credit card to the database </h1>
...
<%
	...
	try(Connection con = DriverManager.getConnection(url, uid, pw);){
			String SQL = "INSERT INTO PayPal (account, cid) VALUES (?, ?)";
			PreparedStatement pstmt = con.prepareStatement(SQL);
			pstmt.setInt(1, Integer.valueOf(account));
			pstmt.setInt(2, Integer.valueOf(cid));
			pstmt.execute();
			out.println("Successfully inserted to the database.");
		}
